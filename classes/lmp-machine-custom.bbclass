...
OSTREE_KERNEL_ARGS_sota_raspberrypi3 = "8250.nr_uarts=1 cma=256M vc_mem.mem_base=0x3ec00000 vc_mem.mem_size=0x40000000 dwc_otg.lpm_enable=0 ${KERNEL_SERIAL} root=LABEL=otaroot rootfstype=ext4"
