...
SRC_URI_append_lmp = " \
    ...
    file://0006-FIO-toup-aktualizr-lite-Rename-version-to-helpers.patch \
    file://0007-config-Add-notion-of-tags-to-package-manager.patch \
    file://0008-aktualizr-lite-Include-passive-status-headers.patch \
    file://0009-aktualizr-lite-Add-targets-equal-helper.patch \
    file://0010-aktualizr-lite-Add-a-daemon-mode.patch \
    file://0011-aktualizr-lite-Add-ability-to-reboot-after-an-update.patch \
    file://0012-aktualizr-lite-Add-lockfile-for-daemon-mode-updates.patch \
