...
KERNEL_DEVICETREE_raspberrypi0-wifi_sota ?= "bcm2708-rpi-0-w.dtb overlays/rpi-ft5406.dtbo overlays/rpi-7inch.dtbo overlays/rpi-7inch-flip.dtbo"
...
OSTREE_KERNEL_ARGS_raspberrypi0-wifi_sota ?= "8250.nr_uarts=1 vc_mem.mem_base=0x1ec00000 vc_mem.mem_size=0x20000000 dwc_otg.lpm_enable=0 console=tty1 ${KERNEL_SERIAL} root=LABEL=otaroot rootfstype=ext4"
OSTREE_KERNEL_ARGS_raspberrypi3_sota ?= "8250.nr_uarts=1 cma=256M vc_mem.mem_base=0x3ec00000 vc_mem.mem_size=0x40000000 dwc_otg.lpm_enable=0 console=tty1 ${KERNEL_SERIAL} root=LABEL=otaroot rootfstype=ext4"
OSTREE_KERNEL_ARGS_raspberrypi-cm3_sota ?= "8250.nr_uarts=1 cma=256M vc_mem.mem_base=0x3ec00000 vc_mem.mem_size=0x40000000 dwc_otg.lpm_enable=0 console=tty1 ${KERNEL_SERIAL} root=LABEL=otaroot rootfstype=ext4"
