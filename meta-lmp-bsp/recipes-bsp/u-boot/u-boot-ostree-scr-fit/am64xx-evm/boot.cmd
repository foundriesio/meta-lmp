...
setenv bootcmd_run 'bootm ${loadaddr}#${name_fit_config}'
...
setenv bootostree 'run bootcmd_load_f; run findfdt; setenv fdtfile ${name_fdt}; run get_fit_config; run bootcmd_run'
