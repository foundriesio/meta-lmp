...
# ERROR: build/conf/../../layers/meta-security/meta-tpm/recipes-tpm/swtpm/swtpm_0.2.0.bb: swtpm: Unable to parse arguments for USERADD_PARAM:swtpm '--system -g tss --home-dir      --no-create-home  --shell /bin/false swtpm':
...
USERADD_PARAM:${PN} = "--system -g ${TSS_GROUP} \
