...
do_compile[depends] += " ${ATF_RECIPE}:do_deploy"
...
/ {
	description = "U-Boot/SPL fitImage with ATF/OP-TEE support";
	#address-cells = <1>;
	images {
		uboot {
	...
	configurations {
		default = "config-1";
		config-1 {
			description = "ATF, OP-TEE with U-Boot in normal world";
			firmware = "atf";
