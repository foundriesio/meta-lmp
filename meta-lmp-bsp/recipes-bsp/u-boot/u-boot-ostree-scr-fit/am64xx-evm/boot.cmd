...
setenv bootloader1_src_image "tiboot3-am64x_sr2-hs-fs-evm.bin"
setenv board_is_closed "0"
fi
if test "${device_type}" = "hs-se"; then
setenv bootloader1_src_image "tiboot3-am64x_sr2-hs-evm.bin"
...
if test ! -e ${devtype} ${devnum}:${bootpart} uboot.env; then saveenv; fi
