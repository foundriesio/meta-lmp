...
KERNEL_SERIAL_rpi = "${@oe.utils.conditional("ENABLE_UART", "1", "console=serial0,115200", "", d)}"
OSTREE_KERNEL_ARGS_sota_raspberrypi0-wifi = "8250.nr_uarts=1 vc_mem.mem_base=0x1ec00000 vc_mem.mem_size=0x20000000 dwc_otg.lpm_enable=0 ${KERNEL_SERIAL} root=LABEL=otaroot rootfstype=ext4"
OSTREE_KERNEL_ARGS_sota_raspberrypi3 = "8250.nr_uarts=1 cma=256M vc_mem.mem_base=0x3ec00000 vc_mem.mem_size=0x40000000 dwc_otg.lpm_enable=0 ${KERNEL_SERIAL} console=ttyS0,115200 root=LABEL=otaroot rootfstype=ext4"
