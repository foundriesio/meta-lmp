...
EXTRA_OEMAKE_append_uz = " \
    CFG_NS_ENTRY_ADDR=0x08000000 CFG_TZDRAM_START=0x60000000 CFG_TZDRAM_SIZE=0x10000000 \
    CFG_CORE_DYN_SHM=n CFG_CORE_ASLR=n CFG_DT=y CFG_EXTERNAL_DTB_OVERLAY=y CFG_DT_ADDR=0x22000000 \
"
